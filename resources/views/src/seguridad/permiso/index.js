...
export default class IndexPermiso extends Component {
    ...
    async updateVisitas () {
        let count = await functios.obtenerVisitas(paginas.permiso);
        functios.incrementarVisitas(paginas.permiso);
        this.setState({
            visitas: count+1
        });
    }
    ...
    getData() {
        axios.get(ws.permiso_index).then(
            response => {
                ...
                <div className="cards" style={{
                    ...
                    <div className="forms-groups">
                        <div className="pulls-left">
                            <h1 className="lbls-txts">Lista de Permiso</h1>
                        </div>

                        <div className="pulls-right">
                            <Link to={routes.permiso_create} className="btn-shadow-primary btn btn-primary btn-lg">
                                Nuevo
                            </Link>
                        </div>
