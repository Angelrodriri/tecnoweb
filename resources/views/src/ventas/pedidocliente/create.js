...
export default class CreatePedidoCliente extends Component {
    ...
    getData() {
        ...
        axios.get(ws.pedido_cliente_create)
        .then(resp => {
            resp = resp.data;
    ...
    guardarPedido() {
        ...
        axios.post(ws.pedido_cliente_store, body)
        .then(resp => {
            resp = resp.data;
                        ...
                        <div className="forms-groups">
                            ...
                            <div className="cols-lg-12 cols-md-12 cols-sm-12 cols-xs-12">
                                ...
                                <div className="txts-center">
                                    ...
                                    <button 
                                        type='button' 
                                        onClick={this.guardarPedido.bind(this)}
